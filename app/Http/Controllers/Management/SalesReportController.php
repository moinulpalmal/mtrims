...
class SalesReportController extends Controller
{
    public function report(){
        ...
        return view('management.sales.generate', compact('buyers', 'trimsTypes'));
    }
    ...
    public function reportGenerate(Request $request){
        ...
        return view('management.sales.sales-report-print-view', compact('sales', 'totalQty',
            'grandTotalPrice', 'from_date', 'to_date'));
        //return $request->all();
    }
}
