...
class PurchaseOrderController extends Controller
{
    public function index(){
        ...
        $purchaseOrders = PurchaseOrderMaster::getActivePurchaseOrderByLpd(2);

        return view('lpd2.purchase-order.index', compact('purchaseOrders'));
    }
    ...
    public function newPurchaseOrder(){
        ...
        return view('lpd2.purchase-order.add',
    ...
    public function savePurchaseOrder(Request $request){
        ...
        return redirect()->route('lpd2.purchase.order.detail', ['id' => $purchaseOrderMaster->id]);
    }
    ...
    public function details($id){
        ...
        if($purchaseOrder->lpd == 2){
            if($purchaseOrder == null){
                ...
                $proformaInvoices = ProformaInvoiceMaster::orderBy('id')
                    ->where('purchase_order_master_id', $id)
                    ->where('status', '!=', 'D')
                    ->get();
                ...
                return view('lpd2.purchase-order.detail',
                    compact('units','buyers', 'trimsTypes',
                        'factories', 'stores', 'purchaseOrder', 'deliveryMasters',
                        'purchaseOrderDetails', 'proformaInvoices', 'productionPlanDetails',
                        'deliveryData', 'uniqTrimsTypes', 'deleteAccess', 'currentStocks'));
            } // other data
        }
        else{
            return redirect()->route('lpd2.purchase.order');
    ...
    public function poComplete(Request $request){
        $purchaseOrder = PurchaseOrderMaster::find($request->id);
        ...
        if($purchaseOrder->lpd == 2){
            if($purchaseOrder == null){
                ...
                $uniqTrimsTypes = DB::table('purchase_order_details')
                    ...
                    ->where('purchase_order_details.purchase_order_master_id', $id)
                    ->orderBy('trims_types.name')
                    ->groupBy('purchase_order_details.trims_type_id')
                    ->get();
                ...
                return view('lpd2.purchase-order.plan-print-view',
    ...
    public function achievementReport($id){
        ...
        if($purchaseOrder->lpd == 2){
            if($purchaseOrder == null){
                ...
                return view('lpd2.purchase-order.achievement-print-view',
                    compact('uniqTrimsTypes', 'productionPlanDetails', 'purchaseOrder'));
            } // other data
        }
        else{
    ...
    public function currentStockReport($id){
        ...
        if($purchaseOrder->lpd == 2){
            if($purchaseOrder == null){
                ...
                return view('lpd2.purchase-order.stock-print-view',
                    compact('uniqTrimsTypes', 'productionPlanDetails', 'purchaseOrder'));
            } // other data
        }
        else{
    ...
    public function deliveryReport($id){
        ...
        if($purchaseOrder->lpd == 2){
            if($purchaseOrder == null){
                ...
                return view('lpd2.purchase-order.delivery-print-view',
    ...
    public function deliveryReportNotApproved($id){
        ...
        if($purchaseOrder->lpd == 2){
            if($purchaseOrder == null){
                ...
                return view('lpd2.purchase-order.delivery-not-print-view',
                    compact('uniqTrimsTypes', 'deliveryData', 'purchaseOrder'));
            } // other data
        }
        else{
