...
class UserController extends Controller
{
    public function index(){
        ...
        return view('admin.user.index', compact('factories', 'users'));
    }
    ...
    public function historicalUser()
    {
        ...
        return view('admin.user.historical', compact('users', 'factories'));
    }
...
//            'profile_picture' => 'required|mimes:jpeg,png,jpg',
    ...
    public function editUser($id)
    {
        ...
        if($user != null){
            ...
            return view('admin.user.edit',
                compact('departments','factories', 'user'));
    ...
    {
        $user = User::onlyTrashed()->with('roles')->find($request->id);
        $user->roles()->detach();
        $user->tasks()->detach();
