    ...
    <div class="page page-dashboard">
        <div class="pageheader ">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('production.report.profit')}}"> Production Profit Report</a>
                    </li>
                    <li>
                        <a href="#"> Print View</a>
                    </li>
        ...
        <div class="add-nav">
            <div class="nav-heading">
                <h3>Profit / Loss Report : <strong class="text-greensea"></strong></h3>
                <span class="controls pull-right">
                    <a href="{{route('production.report.profit')}}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Back"><i class="fa fa-times"></i></a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered table-condensed">
                                                ...
                                                <tr style="height: 3px !important;">
                                                    ...
                                                    <th class="text-uppercase text-center" style="font-size: x-small !important;">Production Date</th>
                                                    <th class="text-uppercase text-center" style="font-size: x-small !important;">Labour, Machine & O/H Cost</th>
                                                    <th class="text-uppercase text-center" style="font-size: x-small !important;">Average Raw Materials Cost</th>
                                                    <th class="text-uppercase text-center" style="font-size: x-small !important;">Total Cost</th>
                                                    <th class="text-uppercase text-center" style=" font-size: x-small !important;">Revenue</th>
                                                    <th class="text-uppercase text-center" style="font-size: x-small !important;">Profit / Loss per day</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                @php($i = 1)
                                                @foreach($reportDataMaster as $item)
                                                    <tr style="height: 3px !important;">
                                                        ...
                                                        <td style="font-size: xx-small !important;" class="text-center"><P>{{ \Carbon\Carbon::parse($item->production_date)->format('j-M-Y') }}</P></td>
                                                        <td style="font-size: xx-small !important;" class="text-right"><P>$ {!! $item->machine_cost_in_usd !!}</P></td>
                                                        <td style="font-size: xx-small !important;" class="text-right"><P>$ {!! $item->material_cost_in_usd !!}</P></td>
                                                        <td style="font-size: xx-small !important;" class="text-right"><P>$ {{ $item->material_cost_in_usd + $item->machine_cost_in_usd }}</P></td>
                                                        <td style="font-size: xx-small !important;" class="text-right"><P>$ {{ \App\Helpers\Helper::GetTotalProductionRevenue($item->id)[0]->total_revenue }}</P></td>
                                                        <td style="font-size: xx-small !important;" class="text-right"><P>$ {{ (\App\Helpers\Helper::GetTotalProductionRevenue($item->id)[0]->total_revenue)- ($item->machine_cost_in_usd + $item->material_cost_in_usd) }}</P></td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
