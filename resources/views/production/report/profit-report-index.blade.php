            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Production Profit/Loss</strong> <span>// Report Section</span></h1>
                        <ul class="controls">
                            <li class="dropdown">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <!-- tile -->
                            <form method="post" id="FactoryAdd" action="{{route('production.report.profit.generate')}}" name="MachineForm" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <section class="tile">
                                    <!-- tile header -->
                                    <div class="tile-header dvd dvd-btm">
