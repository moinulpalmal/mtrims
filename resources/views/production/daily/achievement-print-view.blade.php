        ...
        <div class="pageheader ">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#"> Production Plan Achievement Print View</a>
                    </li>
                </ul>
            </div>
        </div>
...
{{--                                                    <li><strong>Factory:</strong> 9/Kha Confidence Center, Shahazadpur, Gulshan, Dhaka-1212</li>--}}
                                            ...
                                            <div class="col-md-4 text-right">
                                                <h4 class="mb-0 text-custom text-strong"><strong class="text-greensea">Daily Achievement Report</strong></h4>
...
{{--                                                            <th style="font-size: x-small !important;">No Head</th>--}}
                                                            ...
                                                            <th style="font-size: x-small !important;">Achievement</th>
                                                            <th style="font-size: x-small !important;">Variation</th>
                                                            <th style="font-size: x-small !important;">Remarks</th>

                                                            {{--<th style="font-size: x-small !important;  width: 2.7cm !important;">Production Area</th>
                                                            <th style=" font-size: x-small !important;  width: 1.2cm !important;">PO No</th>
                                                            <th style="font-size: x-small !important; width: 2.7cm !important;">Delivery Location</th>
                                                            <th style="font-size: x-small !important; width: 1.2cm !important;">Buyer</th>
                                                            <th style="font-size: x-small !important; width: 2.4cm !important;">Item Description</th>
                                                            <th style="font-size: x-small !important; width: 0.9cm !important;">Size</th>
                                                            <th style="font-size: x-small !important; width: 1.3cm !important;">Color</th>
                                                            --}}{{--                                                            <th style="font-size: x-small !important; width: 1.5cm !important;">No Head</th>--}}{{--
                                                            <th style="font-size: x-small !important; width: 0.8cm !important;">Unit</th>
                                                            <th style="font-size: x-small !important; width: 1.0cm !important;">Target</th>
                                                            <th style="font-size: x-small !important; width: 1.8cm !important;">Achievement</th>
                                                            <th style="font-size: x-small !important; width: 1.4cm !important;">Variation</th>
                                                            <th style="font-size: x-small !important; width: 1.6cm !important;">Remarks</th>--}}
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        @foreach($productionPlanDetails as $item)
                                                            @if((\App\Helpers\Helper::IDwiseData('trims_types', 'id', (\App\Helpers\Helper::TwoIDwiseData('purchase_order_details', 'purchase_order_master_id', $item->purchase_order_master_id, 'item_count', $item->purchase_order_detail_id))->trims_type_id))->section_setup_id == $itemTrims->id)
                                                                <tr style="height: 3px !important;">
                                                                    ...
                                                                    <td style="font-size: xx-small !important;"><p>{!! (\App\Helpers\Helper::IDwiseData('purchase_order_masters', 'id', $item->purchase_order_master_id))->lpd_po_no !!}</p></td>
...
{{--                                                                    <td style="font-size: xx-small !important;" class="text-right"><p>{!! $item->no_of_heads !!}</p></td>--}}
                                                                    ...
                                                                    <td style="font-size: xx-small !important;" class="text-right"><p>{!! $item->achievement_production !!}</p></td>
                                                                    <td style="font-size: xx-small !important;" class="text-right"><P>{!! $item->target_production - $item->achievement_production !!}</P></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right"><p><b>{!! (\App\Helpers\Helper::GetTotalProductionCountSectionSetup($productionPlanMaster->id, $itemTrims->id))->total_achievement_production !!}</b></p></td>
                                                            <td class="text-right"><p><b>{!! (\App\Helpers\Helper::GetTotalProductionCountSectionSetup($productionPlanMaster->id, $itemTrims->id))->total_variation_production !!}</b></p></td>
...
{{--                                            <li><strong class="inline-block w-sm">Total Due:</strong> <h3 class="inline-block text-success ng-binding">$890.21</h3></li>--}}
                            ...
                            <div class="col-md-offset-5 col-md-3 price-total">
                                <!-- tile -->
                                <section class="tile tile-simple bg-tr-black lter">
                                    <!-- tile body -->
                                    <div class="tile-body">
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="ng-binding"><strong class="inline-block w-sm mb-7">Labour, Machine & O/H:</strong> $ {!! $productionPlanMaster->machine_cost_in_usd !!}</li>
                                            <li class="ng-binding"><strong class="inline-block w-sm mb-7">Raw Materials:</strong> $ {!! $productionPlanMaster->material_cost_in_usd !!}</li>
                                            <li class="ng-binding"><strong class="inline-block w-sm mb-7">Total Cost:</strong> $ {!! $productionPlanMaster->machine_cost_in_usd +  $productionPlanMaster->material_cost_in_usd !!}</li>
                                            <h4 class="text-blue">Revenue:</h4>
                                            <li class="ng-binding"><strong class="inline-block w-sm mb-7">Total Revenue:</strong> $ {!! \App\Helpers\Helper::GetTotalProductionRevenue($productionPlanMaster->id)[0]->total_revenue !!}</li>
                                            <li class="ng-binding"><strong class="inline-block w-sm mb-5">Total Refunded:</strong> $0.00</li>
                                            @if(((\App\Helpers\Helper::GetTotalProductionRevenue($productionPlanMaster->id)[0]->total_revenue) - ($productionPlanMaster->machine_cost_in_usd +  $productionPlanMaster->material_cost_in_usd)) < 0 )
                                                <li><strong class="inline-block w-sm">Loss: </strong> <h3 class="inline-block text-danger ng-binding"> $ {!! ($productionPlanMaster->machine_cost_in_usd +  $productionPlanMaster->material_cost_in_usd)-(\App\Helpers\Helper::GetTotalProductionRevenue($productionPlanMaster->id)[0]->total_revenue) !!}</h3></li>

                                            @else
                                                <li><strong class="inline-block w-sm">Profit: </strong> <h3 class="inline-block text-success ng-binding"> $ {!! (\App\Helpers\Helper::GetTotalProductionRevenue($productionPlanMaster->id)[0]->total_revenue) - ($productionPlanMaster->machine_cost_in_usd +  $productionPlanMaster->material_cost_in_usd) !!}</h3></li>
