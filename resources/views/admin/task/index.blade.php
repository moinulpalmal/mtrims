...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader ">
            <h2>Tasks <span>Task List</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('admin.user.task')}}"> Tasks</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Task</strong> Insert/Update Form</h1>
                            ...
                            <div class="row" style="padding: 0px 15px;">
                                ...
                                <div class="col-md-2 no-padding">
                                    <div class="form-group">
                                        <label for="RoleID" class="control-label">Select Role Group</label>
                                        <select class="form-control" name="role_name"  id="RoleID" style="width: 100%;" required>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <section class="tile">
                    <!-- tile header -->
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Task</strong> List</h1>
                        <ul class="controls">
                            <li class="dropdown">
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $("#RoleID option[value = '" + data.role_id + "']").attr('selected', 'selected').change();
                },
                error:function(error){
                    //console.log(error);
                    swal({
