...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader ">
            <h2>Roles <span>Role List</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('admin.user.role')}}"> Roles</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Role</strong> Insert/Update Form</h1>
                            ...
                            <div class="row" style="padding: 0px 15px;">
                                ...
                                <div class="col-md-3 no-padding">
                                    <div class="form-group">
                                        <label for="FactoryName" class="control-label">Role Name</label>
                                        <input type="text" class="form-control" name="name" id="FactoryName" placeholder="Enter factory name" required="">
                                    </div>
                                </div>
                                <div class="col-md-3 no-padding">
                                    <div class="form-group">
                                        <label for="ShortName" class="control-label">Role View Name</label>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <section class="tile">
                    <!-- tile header -->
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Role</strong> List</h1>
                        <ul class="controls">
                            <li class="dropdown">
