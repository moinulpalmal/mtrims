...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader ">
            <h2>Category Name <span>Category Name List</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('admin.product.category')}}"> Product Category</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Product Category</strong> Insert/Update Form</h1>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <section class="tile">
                    <!-- tile header -->
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Product Category</strong> List</h1>
                        <ul class="controls">
                            <li class="dropdown">
    ...
    <script>
        ...
        function loadDataTable() {
           ...
           // $('tbody').html(free_table);
            table = $("#advanced-usage").DataTable({
                ajax: {
                    url: "/mtrims/public/api/admin/product-category/not-deleted",
                    dataSrc: ""
                },
                columns: [
                    {
        ...
        $(function(){
            ...
            $('#FactoryAdd').submit(function(e){
                ...
                // console.log(data);
                var url = '{{ route('admin.product.category.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('admin.product.category.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
        ...
        $('#advanced-usage').on('click',".ActivateBuyer", function(){
            ...
            var url = '{{ route('admin.product.category.activate') }}';
            swal({
                title: 'Are you sure?',
                text: 'This product category will be a active one!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function(value) {
                if (value) {
        ...
        $('#advanced-usage').on('click',".DeActivateBuyer", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('admin.product.category.de-activate') }}';
            swal({
                title: 'Are you sure?',
                text: 'This product category will be in-active!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function(value) {
                if (value) {
        ...
        $('#advanced-usage').on('click',".DeleteBuyer", function(){
            ...
            swal({
                title: 'Are you sure?',
                text: 'This product category will be removed permanently!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function(value) {
                if (value) {
