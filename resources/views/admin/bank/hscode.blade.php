...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader ">
            <h2>HS Code <span>HS Code List</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('admin.bank.hs-code')}}"> HS Code</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <form method="post" id="FactoryAdd" enctype="multipart/form-data">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>HS Code</strong> Insert/Update Form</h1>
                            ...
                            <div class="row" style="padding: 0px 15px;">
                                <div class="col-md-4 no-padding">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="code" id="HSCode" placeholder="Enter HS Code" required="">
                                    </div>
                                </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <section class="tile">
                    <!-- tile header -->
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>HS Code</strong> List</h1>
                        <ul class="controls">
                            <li class="dropdown">
    ...
    <script>
        ...
        function loadDataTable() {
           ...
           // $('tbody').html(free_table);
            table = $("#advanced-usage").DataTable({
                ajax: {
                    url: "/mtrims/public/api/admin/bank-hs-code/not-deleted",
                    dataSrc: ""
                },
                columns: [
                    {
        ...
        $(function(){
            ...
            $('#FactoryAdd').submit(function(e){
                ...
                console.log(data);
                var url = '{{ route('admin.bank.hs-code.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('admin.bank.hs-code.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
        ...
        $('#advanced-usage').on('click',".ActivateBuyer", function(){
            ...
            var url = '{{ route('admin.bank.hs-code.activate') }}';
            swal({
                title: 'Are you sure?',
                text: 'This hs-code will be a active one!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function(value) {
                if (value) {
        ...
        $('#advanced-usage').on('click',".DeActivateBuyer", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('admin.bank.hs-code.de-activate') }}';
            swal({
                title: 'Are you sure?',
                text: 'This hs-code will be in-active!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function(value) {
                if (value) {
        ...
        $('#advanced-usage').on('click',".DeleteBuyer", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('admin.bank.hs-code.delete') }}';
            swal({
                title: 'Are you sure?',
                text: 'This hs-code will be removed permanently!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function(value) {
                if (value) {
