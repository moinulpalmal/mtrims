            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                <!-- tile -->
                <section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Trims Item</strong> In-House Finished Item List</h1>
                        <ul class="controls">
                            <li class="dropdown">
...
@section('pageScripts')
    ...
    <script>
        ...
        $('#advanced-usage{{$itemTrims->id}}').on('click',".DeActivateBuyer", function(){
            ...
            var url = '{{ route('store.receive.trims.finished-in-house.stored') }}';
            swal({
                title: 'Are you sure?',
                text: 'This trims item will be stored in the stock!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function(value) {
                if (value) {
