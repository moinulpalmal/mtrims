...
@section('title')
    Left Over Trims Receive Transaction
@endsection
@section('content')
    <style type="text/css">
        /* th{
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#"> Left Over Trims Item Receive Transactions</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                <!-- tile -->
                <section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Left Over Trims Item</strong> Receiver Transaction</h1>
                        <ul class="controls">
                            <li class="dropdown">
