        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('store.stock.blocked-trims')}}"> Blocked Current Stock</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                <!-- tile -->
                <section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Trims Item</strong> Blocked Stock List</h1>
                        <ul class="controls">
                            <li class="dropdown">
                                            ...
                                            <table class="table table-hover table-bordered table-condensed" id="advanced-usage">
                                                ...
                                                @foreach($activeProductionPlans as $item)
                                                        <tr>
                                                            ...
                                                            <td class="text-right">{!! $item->stock_quantity - $item->delivered_quantity !!}</td>
