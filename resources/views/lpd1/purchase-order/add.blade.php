    ...
    <script>
        ...
        function addRow()
        {
            ...
            var tr = '<tr>'+
                ...
                '<td width="7%"><input type="number" step="any" class="form-control qty" name="quantity['+rowID+']" ></td>'+
                '<td width="7%"><input type="number" step="any" class="form-control s_qty" name="s_quantity['+rowID+']" ></td>'+
