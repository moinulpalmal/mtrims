        ...
        <div class="pageheader ">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#"> Item Delivery Not Approved Print View</a>
                    </li>
                </ul>
            </div>
        </div>
                                    ...
                                    <div class="tile-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 text-right">
                                                <h4 class="mb-0 text-custom text-strong"><strong class="text-greensea">Not Approved Delivery Report</strong></h4>
                                                <ul class="list-unstyled text-default lt mb-20">
...
{{--                                                    <th class="text-uppercase text-center" style="font-size: x-small !important;">Production Date</th>--}}
                                                    <th class="text-uppercase text-center" style="font-size: x-small !important;">Delivery Date</th>
                                                ...
                                                @foreach($deliveryData as $item)
                                                    <tr style="height: 3px !important;">
                                                        ...
                                                        <td style="font-size: xx-small !important;" class="text-left"><P>{!! $item->trims_type_name !!}</P></td>
