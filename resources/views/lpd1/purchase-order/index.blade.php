            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <section class="tile">
                    ...
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font"><strong>Purchase Order List</strong> <span>// Current Active Purchase Order List</span></h1>
                        <ul class="controls">
                            <li class="dropdown">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-bordered table-condensed table-responsive" id="advanced-usage">
                                ...
                                <tr style="background-color: #1693A5; color: white;">
                                    ...
                                    <th class="text-center">Total Order Qty.</th>
                                    <th class="text-center">Total Balance Qty.</th>
                                ...
                                @foreach($purchaseOrders as $item)
                                    <tr>
                                        ...
                                        <td class="text-right">{{ (App\Helpers\Helper::GetTotalOrderQuantityMaster($item->id)) }}</td>
                                        <td class="text-right">{{ (App\Helpers\Helper::GetSuggestedProductionQuantityMaster($item->id)) }}</td>
...
{{--                                            <button class="btn btn-info btn-xs" data-toggle="modal" data-target="#user{{$item->id}}" data-options="splash-2 splash-ef-12"><i class="fa fa-eye"></i></button>--}}
                                ...
                                <tr >
                                    ...
                                    <td class="text-center">Total Order Qty.</td>
                                    <td class="text-center">Total Balance Qty.</td>
