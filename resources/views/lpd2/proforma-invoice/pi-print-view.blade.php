        ...
        <div class="add-nav">
            <div class="nav-heading">
                ...
                <span class="controls pull-right">
                    <a href="{{route('lpd2.proforma-invoice.po.pi-list',['id'=>$purchaseOrder->id])}}" class="btn btn-ef btn-ef-1 btn-ef-1-default btn-ef-1a btn-rounded-20 mr-5" data-toggle="tooltip" title="Back"><i class="fa fa-times"></i></a>
                                            ...
                                            <div class="col-md-6 text-right">
                                                ...
                                                <ul class="list-unstyled text-default lt mb-20">
                                                    <li><strong>PI No:</strong> HTL -  @foreach($uniqTrimsTypes as $item)
                                                            {{ $item->short_name }} -
                                                        @endforeach
														{{$proformaInvoice->job_no}}/{{$proformaInvoice->job_year}}@if($proformaInvoice->is_revise == true) - R/{{($proformaInvoice->pi_revise_count)}}@endif</li>
