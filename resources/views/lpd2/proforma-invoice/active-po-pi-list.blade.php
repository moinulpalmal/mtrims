        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('lpd2.proforma-invoice.po.pi-list',['id'=>$purchaseOrder->id])}}"> LPD-2 PO: {{$purchaseOrder->id}}</a>
                    </li>
                    <li>
                    ...
                    <section id="purchase-order" class="tile tile-simple">
                        ...
                        <div class="tile-widget p-30 text-center">
                            ...
                            <div class="mt-10">
                                ...
                                @if(Auth::user()->hasTaskPermission('lpdtwocreatepi', Auth::user()->id))
                                                                    ...
                                                                    @foreach($proformaInvoices as $item)
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">
                                                                                @if(Auth::user()->hasTaskPermission('lpdtwoupdatepi', Auth::user()->id))
                                                                                    @if($item->is_follow_pi == true)
                                                                                        ...
                                                                                        @endif
                                                                                @endif
                                                                                <a target="_blank" href="{{route('lpd2.proforma-invoice.download', ['id' => $item->id])}}" title="Download PI" class ="btn btn-danger btn-xs">
                                                                                        <i class="fa fa-file-pdf-o"></i>
                                                                                </a>
                                                                                    @if(Auth::user()->hasTaskPermission('lpdtwoapprovepi', Auth::user()->id))
                                                                                       @if($item->status == "I")
                        ...
                        <div class="row" style="padding: 0px 15px;">
                            <div class="col-md-12 no-padding">
                                <div class="form-group">
                                    ...
                                    <textarea size="20" class="form-control" name="bank_information" id="BankInformation"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="padding: 0px 15px;">
                            <div class="col-md-12 no-padding">
                                <div class="form-group">
                                    ...
                                    <textarea size="20" class="form-control" name="terms_conditions" id="TermsCondition"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="padding: 0px 15px;">
                        ...
                        <div class="row" style="padding: 0px 15px;">
                            <div class="col-md-12 no-padding">
                                <div class="form-group">
                                    ...
                                    <textarea size="20" class="form-control" name="bank_information" id="FollowBankInformation"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="padding: 0px 15px;">
                            <div class="col-md-12 no-padding">
                                <div class="form-group">
                                    ...
                                    <textarea size="20" class="form-control" name="terms_conditions" id="FollowTermsCondition"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="padding: 0px 15px;">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row" style="padding: 0px 15px;">
                                <div class="col-md-12 no-padding">
                                    <div class="form-group">
                                        <label for="AmountInWords" class="control-label">Amount in Words</label>
                                        <input type="text" class="form-control" name="amount_in_words" id="AmountInWords" required onkeypress="return /^[a-zA-Z ]+$/.test(event.key)" value="{{ old('amount_in_words', $itemPI->total_pi_amount_words) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="padding: 0px 15px;">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row" style="padding: 0px 15px;">
                                <div class="col-md-12 no-padding">
                                    <div class="form-group">
                                        <label for="AmountInWords" class="control-label">Amount in Words</label>
                                        <input type="text" class="form-control" name="amount_in_words" onkeypress="return /^[a-zA-Z ]+$/.test(event.key)" id="AmountInWords" required value="{{ old('amount_in_words', $itemPI->total_pi_amount_words) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="padding: 0px 15px;">
...
@section('pageScripts')
    <script>
        ...
        $('#pi-table').on('click',".ApproveDetail", function(){
            ...
            var url = '{{ route('lpd2.proforma-invoice.approve') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#pi-table').on('click',".DeleteDetail", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('lpd2.proforma-invoice.delete') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#pi-table').on('click',".DisApproveDetail", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('lpd2.proforma-invoice.reject') }}';
            swal({
                title: 'Are you sure?',
        ...
        $(function(){
            ...
            $('#PIGenerate').submit(function(e){
                ...
                if(terms_conditions == ""){
                    ...
                    var url = '{{ route('lpd2.proforma-invoice.po.pi-single.save') }}';
                    //console.log(data);
                    //return;
                    $.ajax({
                        url: url,
            ...
            $('#FollowPIGenerate').submit(function(e){
               ...
               // var flow_pi_count = document.forms["FollowPIGenerateForm"].getElementsByName('follow_pi_quantity[]');
                ...
                if(terms_conditions == ""){
                    ...
                    var url = '{{ route('lpd2.proforma-invoice.po.pi-follow.save') }}';
                    //console.log(data);
                    //return;
                    $.ajax({
                        url: url,
        ...
        $(function(){
            ...
            $('#FollowPIUpdate{{$itemPI->id}}').submit(function(e){
                ...
                if(terms_conditions == ""){
                    ...
                    var url = '{{ route('lpd2.proforma-invoice.po.pi-follow.update') }}';
                    //console.log(data);
                    //return;
                    $.ajax({
                        url: url,
        ...
        $(function(){
            ...
            $('#PIUpdate{{$itemPI->id}}').submit(function(e){
                ...
                if(terms_conditions == ""){
                    ...
                    var url = '{{ route('lpd2.proforma-invoice.po.pi-single.update') }}';
                    //console.log(data);
                    //return;
                    $.ajax({
                        url: url,
