...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('lpd2.purchase.order.new')}}"> New Purchase Order</a>
                    </li>
                </ul>
        ...
        <!-- row -->
        <form method="post" id="PurchaseOrderFormID" name="PurchaseOrderForm" onsubmit="return validateForm()" action="{{route('lpd2.purchase.order.save')}}" enctype="multipart/form-data" >
            {{ csrf_field() }}
            @include('lpd2.purchase-order.input-form')
        </form>
        <!-- /row -->
    </div>
    @endsection
