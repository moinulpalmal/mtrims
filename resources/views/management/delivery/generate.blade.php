...
@section('content')
    ...
    <div class="page page-dashboard">
        <div class="pageheader">
            <h2>Delivery <span>// Report Generate</span></h2>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{route('management.delivery.report.generate')}}"> Generate Sales Report</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>Delivery Report Generate Form Form</strong></h1>
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <!-- tile -->
                                    <form method="post" id="PurchaseOrderFormID" name="PurchaseOrderForm" action="{{route('management.delivery.report.generate-result')}}" enctype="multipart/form-data" >
                                        {{ csrf_field() }}
                                    <section class="tile">
                                        <!-- tile header -->
                                        <div class="tile-header dvd dvd-btm">
                                            <h1 class="custom-font"><strong>Delivery Report</strong> Search Parameters</h1>
